...
Este es un hecho importante ya que las matrices banda tienen características especiales de las cuales es posible la optimización temporal y espacial para resolver el sistema de ecuaciones con eliminación gausseana, principalmente el hecho de que no es necesario realizar intercambios de filas en el mismo, y esto sucede debido a que la matriz es semidefinida positiva.
